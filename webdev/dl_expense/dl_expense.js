...
function validateSummary() { //step 6
...
function calcClass(sumClass) { //step 7
...
function calcExp() { //step 8
    var expTable = document.getElementById("travelExp").querySelector("tbody").getElementsByTagName("tr");
